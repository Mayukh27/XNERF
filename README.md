...
| Standalone + in-package evaluation | Accuracy/precision/recall/F1/ROC-AUC, per-architecture accuracy, confusion matrices, t-SNE/UMAP embedding plots (`evaluation/`, `xnerf/evaluation/`) | Implemented; **two parallel, overlapping implementations exist** — see [Limitations](#limitations) |
